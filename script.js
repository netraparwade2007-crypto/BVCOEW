...
document.addEventListener(
    ...
    function () {
        ...
        document.getElementById("roomSemester")
    .addEventListener(
        "change",
...
async function addRoom() {
    ...
    /*
       Only prevent the SAME SUBJECT
       from being assigned to the SAME ROOM twice.
    */
    ...
    if (duplicateAssignment) {
        ...
        alert(
            "This subject is already assigned to this room."
        );
    ...
    */
    ...
    alert(
        "Room assigned to the subject successfully."
    );
...
function populateRoomSubjectDropdown() {
    ...
    // Get only subjects belonging to selected semester
    const filteredSubjects =
        subjects.filter(
            subject =>
                subject.semester === semester
...
async function generateAutomaticTimetable() {
    ...
    const selectedYear =
        document.getElementById("timetableYear").value;
...
function placeSubjectAutomatically(subject) {
    ...
    if (!assignedRoom) {
        ...
        console.warn(
            `No room assigned for ${subject.name}`
        );
    ...
    for (
        ...
        for (
            ...
            */
            ...
            /*
               Check year conflict
               Same year cannot have two subjects
